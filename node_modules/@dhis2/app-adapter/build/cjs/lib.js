...
const replaceNewlinesWithBreaks = text => text.split('\n').reduce((out, line, i) => [...out, line, /*#__PURE__*/React__default.createElement("br", {
  key: i
})], []);
...
class FatalErrorBoundary extends React.Component {
  ...
  render() {
    ...
    if (this.state.error) {
      ...
      }, _defaultExport), /*#__PURE__*/React__default.createElement("div", {
        className: "jsx-".concat(_defaultExport.__hash) + " " + "container"
      }, /*#__PURE__*/React__default.createElement("div", {
        className: "jsx-".concat(_defaultExport.__hash) + " " + "message"
      }, i18n.t('Something went wrong')), /*#__PURE__*/React__default.createElement("div", {
        onClick: () => window.location.reload(),
        className: "jsx-".concat(_defaultExport.__hash) + " " + "link"
      }, i18n.t('Refresh to try again')), /*#__PURE__*/React__default.createElement("div", {
        onClick: this.toggleTechInfoDrawer,
        className: "jsx-".concat(_defaultExport.__hash) + " " + "drawerToggle"
      }, this.state.drawerOpen ? i18n.t('Hide technical details') : i18n.t('Show technical details')), /*#__PURE__*/React__default.createElement("div", {
      ...
      }, translatedErrorHeading, /*#__PURE__*/React__default.createElement("br", {
        className: "jsx-".concat(_defaultExport.__hash)
      }), i18n.t('The following information may be requested by technical support.')), /*#__PURE__*/React__default.createElement("div", {
...
const LoginModal = () => {
  const [server, setServer] = React.useState(staticUrl || window.localStorage.DHIS2_BASE_URL || '');
  ...
  return /*#__PURE__*/React__default.createElement(ui.Modal, {
    ...
    onSubmit: onSubmit
  }, /*#__PURE__*/React__default.createElement(ui.ModalTitle, null, i18n.t('Please sign in')), /*#__PURE__*/React__default.createElement(ui.ModalContent, null, !staticUrl && /*#__PURE__*/React__default.createElement(ui.InputField, {
  ...
  })), /*#__PURE__*/React__default.createElement(ui.ModalActions, null, /*#__PURE__*/React__default.createElement(ui.Button, {
    primary: true,
...
const setGlobalLocale = locale => {
  if (locale !== 'en' && locale !== 'en-us') {
    new Promise(function (resolve) { resolve(_interopNamespace(require("moment/locale/".concat(locale)))); }).catch(() => {
      /* ignore */
    });
  }
...
const AuthBoundary = ({
  ...
  const {
    ...
    error,
    data
  } = appRuntime.useDataQuery(settingsQuery);
  useLocale(data && data.userSettings.keyUiLocale);

  if (loading) {
    return /*#__PURE__*/React__default.createElement(ui.Layer, {
      translucent: true,
      level: ui.layers.alert
    }, /*#__PURE__*/React__default.createElement(ui.CenteredContent, null, /*#__PURE__*/React__default.createElement(ui.CircularLoader, null)));
  }

  if (error) {
    return /*#__PURE__*/React__default.createElement(LoginModal, {
      url: url
    });
  }
...
const App = ({
  ...
  appName,
  children
}) => /*#__PURE__*/React__default.createElement(FatalErrorBoundary, null, /*#__PURE__*/React__default.createElement(appRuntime.Provider, {
  config: {
    baseUrl: url,
  ...
  id: styles.__hash
}, styles), /*#__PURE__*/React__default.createElement(ui.HeaderBar, {
  appName: appName
}), /*#__PURE__*/React__default.createElement(AuthBoundary, {
  url: url
}, /*#__PURE__*/React__default.createElement("div", {
