...
import { Field, Box, Input, Card, Divider, MenuItem, LogoIconWhite, Checkbox, Node, CircularLoader, Required, FieldSet, Label as Label$1, FileInput, FileList, FileListPlaceholder, MultiSelect, SingleSelect, Switch, TextArea, Button, IntersectionDetector } from '@dhis2/ui-core';
import { Apps as Apps$1, Settings, Account, Help, Info, Exit, Message, Email, Empty, Single, FolderOpen, FolderClosed } from '@dhis2/ui-icons';
...
class Apps extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "AppMenu", apps => /*#__PURE__*/React.createElement("div", {
  ...
  render() {
    ...
    })), this.state.show && this.AppMenu(apps), appIcon.styles, /*#__PURE__*/React.createElement(_JSXStyle, {
      id: "1265754857"
...
}, img ? /*#__PURE__*/React.createElement(ImageIcon, {
  src: img
...
const getMenuList = () => [{
  ...
  icon: /*#__PURE__*/React.createElement(Account, {
    className: iconStyle.className
  }),
  ...
  icon: /*#__PURE__*/React.createElement(Help, {
    className: iconStyle.className
  }),
  label: i18n.t('Help'),
  value: 'help',
  ...
  icon: /*#__PURE__*/React.createElement(Exit, {
    className: iconStyle.className
  }),
  label: i18n.t('Logout'),
  value: 'logout',
...
const ProfileContents = ({
  ...
  return /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    ...
    value: value,
    icon: icon
  })))), iconStyle.styles, /*#__PURE__*/React.createElement(_JSXStyle, {
    id: "2099675810"
...
class Profile extends React.Component {
  ...
  render() {
    ...
    }, this.userIcon(user, baseUrl), this.state.show ? /*#__PURE__*/React.createElement(ProfileMenu, {
...
const LogoImage = () => {
  ...
  if (!error && pathExists(data)) {
    ...
    Logo = /*#__PURE__*/React.createElement(LogoIconWhite, {
      className: logoStyles.className
    });
  }
...
const SwitchField = ({
  ...
  value: value,
  label: /*#__PURE__*/React.createElement(AddRequired$1, {
    label: label,
    required: required,
    dataTest: dataTest
  }),
...
const borderColor = colors.grey400;
...
const OptionsContainer = ({
  ...
  }), onEndReached && resizeObserver && /*#__PURE__*/React.createElement(EndIntersectionDetector, {
...
export { CheckboxField, FieldGroup, FileInputField, HeaderBar, InputField, MultiSelectField, OrganisationUnitTree, SingleSelectField, SwitchField, TextAreaField, Transfer, TransferOption };
