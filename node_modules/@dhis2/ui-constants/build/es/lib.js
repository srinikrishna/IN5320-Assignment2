...
const popperPlacementPropType = propTypes.oneOf(['auto', 'auto-start', 'auto-end', 'top', 'top-start', 'top-end', 'bottom', // will be used as default
...
const popperReferencePropType = propTypes.oneOfType([// DOM node
...
var sharedPropTypes = /*#__PURE__*/Object.freeze({
    __proto__: null,
    statusPropType: statusPropType,
    buttonVariantPropType: buttonVariantPropType,
    sizePropType: sizePropType,
    insideAlignmentPropType: insideAlignmentPropType,
    popperPlacementPropType: popperPlacementPropType,
    popperReferencePropType: popperReferencePropType
});

export { colors, elevations, layers, sharedPropTypes, spacers, spacersNum, theme };
